               ...
               completion:(void(^)(BOOL success, NSString *filePath, NSError *error))completion
{
    ...
    // 设置请求超时 默认超时时间60s
    [requestM setTimeoutInterval:20.0];
//    [requestM setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];//这个很关键，一定要设置
//    [requestM setValue:@"字段对应的值1" forHTTPHeaderField:@"你头部的字段1"];//这里就是你自己对应的参数
